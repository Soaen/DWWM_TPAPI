    ...
    <div>
        ...
        <form method="POST" @submit.prevent="addDatas">
            ...
            <div>
                ...
                <input type="radio" name="clim" id="clim-no" v-model="carAirCondition" v-bind:value="false" checked>
                ...
                <input type="radio" name="gps" id="gps-no" v-model="carNavigation" v-bind:value="false" checked>
            </div>
